...
execute_process(
    COMMAND "${LUAJIT_BIN}" "${MODULE_REGISTRY_SCRIPT}" "${MODULE_LIST_FILE}" "${MODULE_DIR}" "${MODULE_REGISTRY_C}"
    RESULT_VARIABLE MODULE_REGISTRY_RESULT
    OUTPUT_VARIABLE MODULE_REGISTRY_STDOUT
    ERROR_VARIABLE MODULE_REGISTRY_STDERR
)
if(NOT MODULE_REGISTRY_RESULT EQUAL 0)
    message(FATAL_ERROR
        "Failed to generate module registry:\n${MODULE_REGISTRY_STDOUT}\n${MODULE_REGISTRY_STDERR}"
    )
endif()
